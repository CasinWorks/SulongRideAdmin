...
abstract final class LocalNotificationsService {
  ...
  static Future<void> showTripAccepted() async {
    await _plugin.show(
      1001,
      'Driver on the way',
      'A driver accepted your ${AppStrings.brandName} trip.',
      NotificationDetails(
