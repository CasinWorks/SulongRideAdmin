...
class MaintenanceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isActive = status.phase == AppMaintenancePhase.active;
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Spacer(),
              Icon(
                isActive ? Icons.engineering_outlined : Icons.schedule_outlined,
                size: 56,
              ...
              Text(
                status.message ??
                    'Sulong Ride Driver is temporarily unavailable. Please try again later.',
