...
class ChatMessageBubble extends StatelessWidget {
  const ChatMessageBubble({
    ...
    required this.isDriverBubble,
  });

  final MessageModel message;
  final String currentUserId;
  final bool isDriverBubble;
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      alignment: isDriverBubble ? Alignment.centerRight : Alignment.centerLeft,
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isDriverBubble ? AppColors.ecoGreen : AppColors.forestMedium,
          borderRadius: BorderRadius.only(
            topLeft: const Radius.circular(16),
            topRight: const Radius.circular(16),
            bottomLeft: Radius.circular(isDriverBubble ? 16 : 4),
            bottomRight: Radius.circular(isDriverBubble ? 4 : 16),
          ),
          border: isDriverBubble
              ? null
